...
`,Container$c=styled.div`
  ...
  flex-direction: column;
  padding: 0 12px;
`,renderEncoderError=()=>jsx(ErrorMessage,{children:"Your current firmware does not support rotary encoders. Install the latest firmware for your device."}),Pane$7=()=>{const[e,t]=reactExports.useState(),[o,n]=reactExports.useState(),r=useAppSelector(getSelectedKey),s=useAppDispatch(),a=useAppSelector(getSelectedKeyDefinitions),i=useAppSelector(K=>getSelectedKeymap(K)||[]),c=useAppSelector(getSelectedLayerIndex),l=useAppSelector(getSelectedConnectedDevice),d=useAppSelector(getSelectedKeyboardAPI),u=i[r??-1],C=a[r??-1],_=!!C&&C.col!==-1&&C.row!==-1,h=(K,y)=>{if(d&&r!==null&&C&&C.ei!==void 0){const g=+C.ei;switch(K){case"ccw":{d.setEncoderValue(c,g,!1,y),n(y);break}case"cw":{d.setEncoderValue(c,g,!0,y),t(y);break}case"click":{s(updateKey(r,y));break}}}},p=async(K,y,g)=>{const m=await g.getEncoderValue(K,y,!0),S=await g.getEncoderValue(K,y,!1);t(m),n(S)};return reactExports.useEffect(()=>{if(l&&l.protocol>=10&&C!==void 0&&C.ei!==void 0&&d){const K=+C.ei;p(c,K,d)}},[C,l,c]),C===void 0||l&&l.protocol<10||o===void 0||e===void 0?jsx(SpanOverflowCell,{children:renderEncoderError()}):jsx(SpanOverflowCell,{children:jsx(Encoder,{children:jsxs(Container$c,{children:[jsxs(ControlRow,{children:[jsx(Label$1,{children:"Rotate Counterclockwise"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:o,meta:{},setValue:K=>h("ccw",K)})})]}),jsxs(ControlRow,{children:[jsx(Label$1,{children:"Rotate Clockwise"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:e,meta:{},setValue:K=>h("cw",K)})})]}),_&&jsxs(ControlRow,{children:[jsx(Label$1,{children:"Press Encoder"}),jsx(Detail,{children:jsx(PelpiKeycodeInput,{value:u,meta:{},setValue:K=>h("click",K)})})]})]})})})},KeycodeList=styled.div`
  display: grid;
...
`,componentJoin=(e,t)=>e.reduce((o,n,r)=>(r&&o.push({...t,key:r}),o.push(n),o),[]),KeycodeMap=getKeycodes().flatMap(e=>e.keycodes).reduce((e,t)=>({...e,[t.code]:t}),{}),optimizeKeycodeSequence=e=>pipeline(e,convertCharacterTaps,trimLastWait,mergeConsecutiveWaits,foldKeydownKeyupKeys,convertToCharacterStreams),cleanKeycodeSequence=e=>pipeline(e,mergeConsecutiveWaits),MacroRecorder=({selectedMacro:e,setUnsavedMacro:t,saveMacro:o,undoMacro:n,isDelaySupported:r})=>{const[s,a]=reactExports.useState(!0),[i,c]=reactExports.useState(!1),[l,d]=reactExports.useState(!1),[u,C]=reactExports.useState(!!document.fullscreenElement),{smartOptimizeEnabled:_,recordDelaysEnabled:h}=useAppSelector(getMacroEditorSettings),p=useDispatch(),[K,y]=useKeycodeRecorder(i,h),g=reactExports.useRef(null),m=reactExports.useCallback(async L=>{c(L),L?(await navigator.keyboard.lock(),y([]),a(!1),d(!0)):(navigator.keyboard.unlock(),_&&y(optimizeKeycodeSequence(K)),d(!1))},[K,c]),S=reactExports.useCallback(()=>{o(""),a(!0),d(!1)},[y,o]),M=reactExports.useCallback(()=>{n(),y([]),a(!0),d(!1)},[n]);reactExports.useEffect(()=>{a(!0),d(!1),y([])},[e]);const T=()=>[...s?e??[]:K],x=reactExports.useMemo(()=>{let L,b=T();return s||!l||!_?L=b:L=optimizeKeycodeSequence(b),L},[K,s,_,l,e]);reactExports.useEffect(()=>{x&&t(sequenceToExpression(x))},[x]);const R=reactExports.useCallback(()=>{s&&a(!1)},[s]),O=reactExports.useCallback(L=>{const b=T();b.splice(L,1),y(cleanKeycodeSequence(b)),R()},[x,e,K,s]),P=reactExports.useCallback((L,b)=>{const w=T();w.splice(L,1,[RawKeycodeSequenceAction.Delay,b]),y(cleanKeycodeSequence(w)),R()},[x,e,K,s]),B=reactExports.useMemo(()=>componentJoin(x.map(([L,b],w)=>{const v=getSequenceItemComponent(L);return jsx(Deletable,{index:w,deleteItem:O,disabled:i,children:RawKeycodeSequenceAction.Delay!==L?jsx(v,{children:L===RawKeycodeSequenceAction.CharacterStream?componentJoin(String(b).split(" ").map((I,F)=>jsx("span",{children:I},F)),jsx("span",{style:{fontFamily:"fantasy, cursive, monospace"},children:"␣"})):Array.isArray(b)?b.map(I=>getSequenceLabel(KeycodeMap[I])??I).join(" + "):getSequenceLabel(KeycodeMap[b])}):jsx(WaitInput,{index:w,value:Number(b),updateValue:P})},`${w}-${L}`)}),jsx(SequenceLabelSeparator,{})),[x]);reactExports.useEffect(()=>{const L=()=>{C(!!document.fullscreenElement)};return document.documentElement.addEventListener("fullscreenchange",L),()=>{m(!1),document.documentElement.removeEventListener("fullscreenchange",L)}},[C]);const A=reactExports.useCallback(()=>{document.fullscreenElement?document.exitFullscreen&&(m(!1),document.exitFullscreen()):document.documentElement.requestFullscreen()},[m]);return jsxs(Fragment,{children:[jsx(MacroSequenceContainer,{ref:g,$isModified:!s,children:B.length?B:jsx(NoMacroRecorded,{children:"No macro recorded yet..."})}),jsx("div",{style:{border:"none",maxWidth:960,width:"100%",display:"flex",justifyContent:"center",transform:"translate(-0px, -21px)"},children:jsx(MacroEditControls,{isFullscreen:u,isEmpty:!e||!e.length,optimizeRecording:_,recordDelays:h,isRecording:i,addText:()=>{},deleteMacro:S,toggleOptimizeRecording:()=>{p(setMacroEditorSettings({smartOptimizeEnabled:!_}))},toggleRecordDelays:()=>{p(setMacroEditorSettings({recordDelaysEnabled:!h}))},toggleFullscreen:A,undoChanges:M,saveChanges:()=>o(),hasUnsavedChanges:!s,recordingToggleChange:m,isDelaySupported:r})})]})},TextArea=styled.textarea`
  box-sizing: border-box;
  background: var(--bg_control);
  padding: 5px 10px;
...
`,ColumnDiv=styled.div`
  display: flex;
  flex-direction: column;
`;class EncoderModeToggle extends React.Component{constructor(){super(...arguments);f(this,"handleInputChange",o=>{const{enabledModes:n,onChange:r}=this.props,{target:{checked:s,name:a}}=o,i=1<<MODES[a],c=s?n|i:n&~i;r(c)});f(this,"isChecked",o=>(1<<o&this.props.enabledModes)>0)}render(){return jsxs(CenteredColumnDiv,{children:[jsx("h3",{children:"Enabled Encoder Modes:"}),jsx("p",{children:"Only the selected encoder modes will be available on the keyboard"}),jsx(ColumnDiv,{children:Object.entries(MODES).map(([o,n])=>jsxs("label",{htmlFor:MODE_LABELS[o],children:[jsx("input",{name:o,id:MODE_LABELS[o],type:"checkbox",checked:this.isChecked(n),onChange:this.handleInputChange},n),MODE_LABELS[o]]},n))})]})}}const NormalInput=styled.input`
  border: none;
  border-bottom: 1px solid var(--bg_control);
  color: var(--color_accent);
  background: var(--bg_menu);
...
`,ExternalLinks=()=>jsxs(ExternalLinkContainer,{children:[jsx("a",{href:"https://caniusevia.com/",target:"_blank",children:jsxs(CategoryIconContainer,{children:[jsx(VIALogo,{height:"25px",fill:"currentColor"}),jsx(CategoryMenuTooltip,{children:"Firmware + Docs"})]})}),jsx("a",{href:"https://discord.gg/NStTR5YaPB",target:"_blank",children:jsxs(CategoryIconContainer,{children:[jsx(FontAwesomeIcon,{size:"xl",icon:faDiscord}),jsx(CategoryMenuTooltip,{children:"Discord"})]})}),jsx("a",{href:"https://github.com/the-via/app",target:"_blank",children:jsxs(CategoryIconContainer,{children:[jsx(FontAwesomeIcon,{size:"xl",icon:faGithub}),jsx(CategoryMenuTooltip,{children:"Github"})]})})]}),Container=styled.div`
  ...
  align-items: center;
  justify-content: center;
`,{DEBUG_PROD,MODE:MODE$1,DEV}={BASE_URL:"/",MODE:"production",DEV:!1,PROD:!0,SSR:!1},showDebugPane=MODE$1==="development"||DEBUG_PROD==="true"||DEV,GlobalContainer=styled(Container)`
